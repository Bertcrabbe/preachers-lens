...
- INTRO note: HIGH ENERGY. This is the hype-up opener — bring real enthusiasm, not measured analysis. Open with a punchy generic greeting ("Dude!", "My man —", "Yo,") — NEVER the preacher's first name — then lead with a strong, energetic reaction using signature affirmations ("dynamite," "strong sauce," "top shelf," "this is preaching," "really, really solid"). Use exclamation points where natural. Hit the macro frame (Know/Feel/Do, length, audience) AFTER the energetic opening beat — never lead with critique. The intro should make the preacher feel pumped to read the rest of the notes.
